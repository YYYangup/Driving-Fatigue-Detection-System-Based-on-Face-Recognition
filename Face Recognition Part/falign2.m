function [shape,bbox] = falign2( ShapeModel, DataVariation, DM, img, options )
...
[im, region, bbox_facedet,bbox,sr,sc]= normalize_img(img,canvasSize);
...
if  0
    ...
    points=ginput(2);
    bbox_facedet=[points(1,:) points(2,:)-points(1,:)];
    rectangle('position',bbox_facedet,'EdgeColor','g');
    close;
end
