...
%% do_learn_variation函数功能：根据训练集学习扰动参数
%% loading learned shape model
load([options.modelPath options.slash options.datasetName '_openmouseShapeModel.mat']);
...
save([options.modelPath options.slash options.datasetName ...
    '_openmouseDataVariation.mat'], 'DataVariation');
