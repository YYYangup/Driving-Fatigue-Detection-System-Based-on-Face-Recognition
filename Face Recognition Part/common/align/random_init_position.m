function [rbbox] = random_init_position( bbox, DataVariation, nRandInit )
...
% 
% rCenter = repmat(center,nRandInit-1,1) + rInit_trans.*repmat([bbox(3) bbox(4)],nRandInit-1,1);
% 
...
rCenter = repmat(center,nRandInit-1,1) + rInit_trans;
