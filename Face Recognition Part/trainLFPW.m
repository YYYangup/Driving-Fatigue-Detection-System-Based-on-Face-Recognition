...
%% trainLFPW函数功能：基于LFPW训练集的跟踪模型训练，可以参考trainDMLFWandHelen和trainTMLFWandHelen
%% loading the setup %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
options = setupLFPW( );
...
save('result/Trained_openmouseRMS.mat' , 'rms');
save([options.modelPath options.slash 'lfpw/DM_openmousexxsift.mat'],'TM');
